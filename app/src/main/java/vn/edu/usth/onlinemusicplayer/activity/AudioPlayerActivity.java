...
import vn.edu.usth.onlinemusicplayer.adapter.ViewPagerAdapter;
import vn.edu.usth.onlinemusicplayer.db.FavoritesOperations;
import vn.edu.usth.onlinemusicplayer.fragment.AllSongFragment;
import vn.edu.usth.onlinemusicplayer.fragment.CurrentSongFragment;
import vn.edu.usth.onlinemusicplayer.fragment.FavSongFragment;
import vn.edu.usth.onlinemusicplayer.model.SongsList;

public class AudioPlayerActivity extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed, CurrentSongFragment.createDataParsed {
            ...
            case R.id.img_btn_play:
                if (checkFlag) {
                    if (mediaPlayer.isPlaying()) {
                        mediaPlayer.pause();
                        imgBtnPlayPause.setImageResource(R.drawable.ic_baseline_play_circle_outline_24);
                    } else if (!mediaPlayer.isPlaying()) {
                        mediaPlayer.start();
                        imgBtnPlayPause.setImageResource(R.drawable.ic_baseline_pause_circle_outline_24);
                        playCycle();
                    }
                } else {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                if (playContinueFlag) {
                    if (currentPosition + 1 < songList.size()) {
                        ...
                        Toast.makeText(AudioPlayerActivity.this, "PlayList Ended", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
