...
public class SongPlayerFragment extends MusicServiceFragment {
    ...
    public void handleAllAction() {
        ...
        if (musicService.isPlaying()) {
            actionBtn.setBackgroundResource(R.drawable.ic_baseline_pause_circle_outline_24);
        } else {
            actionBtn.setBackgroundResource(R.drawable.ic_baseline_play_circle_outline_24);
        ...
        if (musicService.isPlaying()) {
            panelPlayBtn.setBackgroundResource(R.drawable.ic_baseline_pause_circle_outline_24);
        } else {
            panelPlayBtn.setBackgroundResource(R.drawable.ic_baseline_play_circle_outline_24);
        }
